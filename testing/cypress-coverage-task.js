...
const tasks = {
  ...
  combineCoverage(sentCoverage) {
    ...
    // keys.forEach((key) => {
    //   previousCoverage[key] = previousCoverage[key] || {}
    //   previousCoverage[key].statementMap = coverage[key].statementMap
    //   previousCoverage[key].fnMap = coverage[key].fnMap
    //   previousCoverage[key].branchMap = coverage[key].branchMap
    // })
    ...
    coverageMap.merge(previousCoverage);
    saveCoverage(coverageMap);
